  ...
  return merge(
    {
      ...
      module: {
        rules: [
          ...
          /*
       ,
       Disabled due to https://github.com/engineeric/generator-engineeric/issues/16116
      ...
      plugins: [
        ...
        new CopyWebpackPlugin({
          patterns: [
            ...
            // engineeric-needle-add-assets-to-webpack - engineeric will add/remove third-party resources in this array
        ...
        new MergeJsonWebpackPlugin({
          output: {
            groupBy: [
              ...
              {
                pattern: "./src/i18n/ar-ly/*.json",
                fileName: "./i18n/ar-ly.json",
              },
              // engineeric-needle-i18n-language-webpack - engineeric will add/remove languages in this array
            ],
          },
        }),
      ],
    }
    // engineeric-needle-add-webpack-config - engineeric will add custom config
  );
};
