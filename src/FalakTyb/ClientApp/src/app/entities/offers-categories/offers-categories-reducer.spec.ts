...
describe("Entities reducer tests", () => {
  ...
  describe("Actions", () => {
    ...
    it("dispatches FETCH_OFFERSCATEGORIES_LIST actions", async () => {
    ...
    it("dispatches FETCH_OFFERSCATEGORIES actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches CREATE_OFFERSCATEGORIES actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches UPDATE_OFFERSCATEGORIES actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches PARTIAL_UPDATE_OFFERSCATEGORIES actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches DELETE_OFFERSCATEGORIES actions", async () => {
      const expectedActions = [
        {
