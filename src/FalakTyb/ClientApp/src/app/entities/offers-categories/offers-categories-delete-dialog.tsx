...
import { getEntity, deleteEntity } from "./offers-categories.reducer";
import { Dialog, Transition } from "@headlessui/react";
import { ExclamationIcon } from "@heroicons/react/solid";

export const OffersCategoriesDeleteDialog = (
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(offersCategoriesEntity.id));
  };
...
export default OffersCategoriesDeleteDialog;
