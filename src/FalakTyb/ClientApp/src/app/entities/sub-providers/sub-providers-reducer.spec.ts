...
describe("Entities reducer tests", () => {
  ...
  describe("Actions", () => {
    ...
    it("dispatches FETCH_SUBPROVIDERS_LIST actions", async () => {
    ...
    it("dispatches FETCH_SUBPROVIDERS actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches CREATE_SUBPROVIDERS actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches UPDATE_SUBPROVIDERS actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches PARTIAL_UPDATE_SUBPROVIDERS actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches DELETE_SUBPROVIDERS actions", async () => {
      const expectedActions = [
        {
