...
import { getEntity, deleteEntity } from "./providers-categories.reducer";
import { Dialog, Transition } from "@headlessui/react";
import { ExclamationIcon } from "@heroicons/react/solid";

export const ProvidersCategoriesDeleteDialog = (
  ...
  const handleClose = () => {
    props.history.push("/providers-categories");
  };
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(providersCategoriesEntity.id));
  };
...
export default ProvidersCategoriesDeleteDialog;
