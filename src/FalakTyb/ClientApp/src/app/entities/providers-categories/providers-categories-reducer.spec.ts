...
describe("Entities reducer tests", () => {
  ...
  describe("Actions", () => {
    ...
    it("dispatches FETCH_PROVIDERSCATEGORIES_LIST actions", async () => {
    ...
    it("dispatches FETCH_PROVIDERSCATEGORIES actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches CREATE_PROVIDERSCATEGORIES actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches UPDATE_PROVIDERSCATEGORIES actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches PARTIAL_UPDATE_PROVIDERSCATEGORIES actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches DELETE_PROVIDERSCATEGORIES actions", async () => {
      const expectedActions = [
        {
