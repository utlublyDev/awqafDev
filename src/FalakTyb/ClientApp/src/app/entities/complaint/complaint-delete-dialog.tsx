...
import { getEntity, deleteEntity } from "./complaint.reducer";

import { ExclamationIcon } from "@heroicons/react/solid";
import { Dialog, Transition } from "@headlessui/react";

export const ComplaintDeleteDialog = (
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(complaintEntity.id));
  };
...
export default ComplaintDeleteDialog;
