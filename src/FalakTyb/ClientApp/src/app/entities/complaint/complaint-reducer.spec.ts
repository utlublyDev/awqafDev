...
describe("Entities reducer tests", () => {
  ...
  describe("Actions", () => {
    ...
    it("dispatches FETCH_COMPLAINT_LIST actions", async () => {
    ...
    it("dispatches FETCH_COMPLAINT actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches CREATE_COMPLAINT actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches UPDATE_COMPLAINT actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches PARTIAL_UPDATE_COMPLAINT actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches DELETE_COMPLAINT actions", async () => {
      const expectedActions = [
        {
