...
describe("Entities reducer tests", () => {
  ...
  describe("Actions", () => {
    ...
    it("dispatches FETCH_OFFERS_LIST actions", async () => {
    ...
    it("dispatches FETCH_OFFERS actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches CREATE_OFFERS actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches UPDATE_OFFERS actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches PARTIAL_UPDATE_OFFERS actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches DELETE_OFFERS actions", async () => {
      const expectedActions = [
        {
