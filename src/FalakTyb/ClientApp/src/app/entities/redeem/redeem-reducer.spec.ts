...
describe("Entities reducer tests", () => {
  ...
  describe("Actions", () => {
    ...
    it("dispatches FETCH_REDEEM_LIST actions", async () => {
    ...
    it("dispatches FETCH_REDEEM actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches CREATE_REDEEM actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches UPDATE_REDEEM actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches PARTIAL_UPDATE_REDEEM actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches DELETE_REDEEM actions", async () => {
      const expectedActions = [
        {
