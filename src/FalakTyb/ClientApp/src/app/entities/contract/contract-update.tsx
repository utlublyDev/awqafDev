...
values.contarctFileUrl = isNew?"https://file.engineeric.qa/engineeric/fileSystem/pdf/"+nameFile:nameFile===""?contractEntity.contarctFileUrl:"https://file.engineeric.qa/engineeric/fileSystem/pdf/"+nameFile;
                    ...
                    <div className="space-y-1 text-center">
                      ...
                      <div className="flex text-sm text-gray-600 ml-1">
                        ...
                        >
                          ...
                          <input id="file-upload"  onChange={changeHandler} name="file-upload" type="file" accept="application/pdf" className="sr-only" />
                        </label>
