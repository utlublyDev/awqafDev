...
describe("Entities reducer tests", () => {
  ...
  describe("Actions", () => {
    ...
    it("dispatches FETCH_SAVEDPROVIDERS_LIST actions", async () => {
    ...
    it("dispatches FETCH_SAVEDPROVIDERS actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches CREATE_SAVEDPROVIDERS actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches UPDATE_SAVEDPROVIDERS actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches PARTIAL_UPDATE_SAVEDPROVIDERS actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches DELETE_SAVEDPROVIDERS actions", async () => {
      const expectedActions = [
        {
