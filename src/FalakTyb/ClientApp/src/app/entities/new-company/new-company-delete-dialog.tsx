...
import { getEntity, deleteEntity } from "./new-company.reducer";
import { Dialog,  Transition } from '@headlessui/react'
import { ExclamationIcon } from "@heroicons/react/solid";

export const NewCompanyDeleteDialog = (
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(newCompanyEntity.id));
  };
...
export default NewCompanyDeleteDialog;
