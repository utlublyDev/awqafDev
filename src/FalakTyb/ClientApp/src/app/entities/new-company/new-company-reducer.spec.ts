...
describe("Entities reducer tests", () => {
  ...
  describe("Actions", () => {
    ...
    it("dispatches FETCH_NEWCOMPANY_LIST actions", async () => {
    ...
    it("dispatches FETCH_NEWCOMPANY actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches CREATE_NEWCOMPANY actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches UPDATE_NEWCOMPANY actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches PARTIAL_UPDATE_NEWCOMPANY actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches DELETE_NEWCOMPANY actions", async () => {
      const expectedActions = [
        {
