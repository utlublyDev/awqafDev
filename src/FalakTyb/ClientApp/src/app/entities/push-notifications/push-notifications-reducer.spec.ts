...
describe("Entities reducer tests", () => {
  ...
  describe("Actions", () => {
    ...
    it("dispatches FETCH_PUSHNOTIFICATIONS_LIST actions", async () => {
    ...
    it("dispatches FETCH_PUSHNOTIFICATIONS actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches CREATE_PUSHNOTIFICATIONS actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches UPDATE_PUSHNOTIFICATIONS actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches PARTIAL_UPDATE_PUSHNOTIFICATIONS actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches DELETE_PUSHNOTIFICATIONS actions", async () => {
      const expectedActions = [
        {
