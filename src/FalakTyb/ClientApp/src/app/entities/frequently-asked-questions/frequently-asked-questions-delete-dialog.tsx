...
import { getEntity, deleteEntity } from "./frequently-asked-questions.reducer";
import { Dialog, Transition } from "@headlessui/react";
import { ExclamationIcon } from "@heroicons/react/solid";

export const FrequentlyAskedQuestionsDeleteDialog = (
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(frequentlyAskedQuestionsEntity.id));
  };
...
export default FrequentlyAskedQuestionsDeleteDialog;
