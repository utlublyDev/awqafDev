...
describe("Entities reducer tests", () => {
  ...
  describe("Actions", () => {
    ...
    it("dispatches FETCH_FREQUENTLYASKEDQUESTIONS_LIST actions", async () => {
    ...
    it("dispatches FETCH_FREQUENTLYASKEDQUESTIONS actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches CREATE_FREQUENTLYASKEDQUESTIONS actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches UPDATE_FREQUENTLYASKEDQUESTIONS actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches PARTIAL_UPDATE_FREQUENTLYASKEDQUESTIONS actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches DELETE_FREQUENTLYASKEDQUESTIONS actions", async () => {
      const expectedActions = [
        {
