...
describe("Entities reducer tests", () => {
  ...
  describe("Actions", () => {
    ...
    it("dispatches FETCH_REVIEWSANDRATING_LIST actions", async () => {
    ...
    it("dispatches FETCH_REVIEWSANDRATING actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches CREATE_REVIEWSANDRATING actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches UPDATE_REVIEWSANDRATING actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches PARTIAL_UPDATE_REVIEWSANDRATING actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches DELETE_REVIEWSANDRATING actions", async () => {
      const expectedActions = [
        {
