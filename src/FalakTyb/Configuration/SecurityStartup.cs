...
using AuthenticationService = awqaf.Domain.Services.AuthenticationService;
using IAuthenticationService = awqaf.Domain.Services.Interfaces.IAuthenticationService;

namespace awqaf.Configuration
{
