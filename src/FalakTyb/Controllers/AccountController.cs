...
namespace awqaf.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        //update setting of account
        [Authorize]
        [HttpPatch("account/notifications")]
        [ValidateModel]
        public async Task<ActionResult> UpdateSetting([FromBody] UpdateSettingObject obj)
        {
          User user=  await _mediator.Send(new AccountSettingChangeCommand { notificationSetting = obj.setting , expoKey=obj.expoKey , lang=obj.lang});
