...
namespace awqaf.Infrastructure.Data
{
  ...
  public DbSet<Providers> Providers { get; set; }
        public DbSet<SubProviders> SubProviders { get; set; }
        public DbSet<ProvidersCategories> ProvidersCategories { get; set; }
        public DbSet<SavedProviders> SavedProviders { get; set; }
        public DbSet<Offers> Offers { get; set; }
        public DbSet<OffersCategories> OffersCategories { get; set; }
        public DbSet<Contract> Contracts { get; set; }
        public DbSet<FrequentlyAskedQuestions> FrequentlyAskedQuestions { get; set; }
        public DbSet<ReviewsAndRating> ReviewsAndRatings { get; set; }
        public DbSet<Notification> Notifications { get; set; }
        public DbSet<PushNotifications> PushNotifications { get; set; }
        public DbSet<Redeem> Redeems { get; set; }
        public DbSet<Complaint> Complaints { get; set; }
        public DbSet<NewCompany> NewCompanies { get; set; }
