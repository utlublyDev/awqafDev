...
using awqaf.Configuration.AutoMapper;
...
namespace awqaf.Test.Controllers
{
    public class UsersResourceIntTest
    {
        ...
        private const string UpdatedLogin = "hossam";

        private const string DefaultId = "id";

        private const string DefaultPassword = "passjohndoe";
        private const string UpdatedPassword = "passhossam";

        private const string DefaultEmail = "johndoe@localhost";
        private const string UpdatedEmail = "yazan@localhost";

        private const string DefaultFirstname = "john";
        private const string UpdatedFirstname = "FirstName";

        private const string DefaultLastname = "doe";
        private const string UpdatedLastname = "LastName";
        ...
        public async Task UpdateUserExistingEmail()
        {
            ...
            var managedUserDto = new ManagedUserDto
            {
                ...
                Email = "yyyyyyy@localhost", //this email should be already used by anotherUser
                Activated = updatedUser.Activated,
        ...
        public async Task UpdateUserExistingLogin()
        {
            ...
            {
                Id = updatedUser.Id,
                Login = "jasim", //this login should be already used by anotherUser
                Password = updatedUser.PasswordHash,
                FirstName = updatedUser.FirstName,
                LastName = updatedUser.LastName,
